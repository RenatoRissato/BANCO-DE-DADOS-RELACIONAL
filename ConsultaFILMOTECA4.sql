...
SELECT A.NOME_ATOR, COUNT(NOME_PERSONAGEM) AS 'QTDE'
FROM ATOR A 
JOIN FILME_ATOR FA
ON A.ID_ATOR = FA.ID_ATOR
JOIN FILME F
...
SELECT NOME_ORIGINAL_FILME, COUNT (NOME_ATOR) AS 'QTDE DE ATORES'
FROM FILME F
JOIN FILME_ATOR FA
ON F.ID_FILME = FA.ID_FILME
JOIN ATOR A 
